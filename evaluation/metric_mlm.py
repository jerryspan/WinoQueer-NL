...
def evaluate(args):
    ...
    elif any(x in args.lm_model_path for x in ["gpt2", "bloom", "bart"]):
    ...
    print("For pasting into spreadsheet (Order Overall, LHBTI, Queer, Transgender, Non-binair, Biseksueel, Panseksueel, Lesbisch, Aseksueel, Homo):")
